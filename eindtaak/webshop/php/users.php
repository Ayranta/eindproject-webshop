...
<div class="products">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="filters-content">
                    <div class="row grid">
                        ...
                        $sql = "SELECT gebruikernummer, naam, voornaam,email FROM klanten";
                            ...
                            echo ' <div class="col-md-4">
                                 <div class="product-item">
                                        <div class="down-content">
                                            <a><h4>' . $row["naam"] . '</h4><h4>'.$row["voornaam"].'</h4></a>
                                              <p>' . $row["email"] . '</p>
            ...
            <ul>
                    <li class="nav-item">
                    <a class="nav-link" href=wijzig_klanten.php?veranderen=' . $row["gebruikernummer"] . '>wijzigen</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href=wissen_klanten.php?wissen=' . $row["gebruikernummer"] . '>wissen</a>
                    </li>
                    <li class="nav-item">
                        ...
                        echo '<a class="nav-link" href="toevoegen_klanten.php">toevoegen</a>';
                        echo "</table>";
                        ?>
