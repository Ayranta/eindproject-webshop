...
if (isset($_POST['knop'])) {
    ...
    $sql = "INSERT INTO klanten (naam, voornaam, wachtwoord, email) VALUES ('" . $naam . "', '" . $voornaam . "', 
        '" . $wachtwoord . "', '" . $email . "')";
    ...
    $sql="SELECT gebruikernummer,email,wachtwoord FROM klanten Where email='$email'AND wachtwoord='$wachtwoord' ";
