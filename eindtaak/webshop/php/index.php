      ...
      <div class="container">
        <div class="row">
          ...
          <?php
            ...
            $sql = "SELECT artikelnummer, artikelnaam, prijs,afbeelding,extraUitleg FROM artikel";
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-image">
              <img src="https://www.topmotoapeldoorn.nl/wp-content/uploads/2022/01/binnenbocht-yamaha-logo.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>
            - Design from Xander. find me at: xander.nauwelaerts@bazandpoort.com </p>
            </div>
          </div>
        </div>
      </div>
