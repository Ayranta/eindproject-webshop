...
if (isset($_POST['knop'])) {
    ...
    include "connect.php";
    $sql = "INSERT INTO artikel (artikelnaam, prijs, afbeelding, extraUitleg) VALUES ('" . $naam . "', '" . $prijs . "', 
        '" . $afbeelding . "', '" . $extraUitleg . "')";
    if ($mysqli->query($sql)) {
...
<form method="post" action="toevoegen.php">
    <h3>toevoegen hier</h3>
                ...
                <input type="text" name="naam" id="naam" placeholder="naam">
                  ...
                  <input type="text" name="afbeelding" id="afbeelding" placeholder="afbeelding">
                  <input type="textarea" id="extraUitleg"  name="extraUitleg" placeholder="extraUitleg"  >
